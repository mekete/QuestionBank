...
public class StepPagerStrip extends View {
    ...
    public StepPagerStrip(@NonNull Context context) {
        this(context, null, 0);
    }

    public StepPagerStrip(@NonNull Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public StepPagerStrip(@NonNull Context context, AttributeSet attrs, int defStyle) {
