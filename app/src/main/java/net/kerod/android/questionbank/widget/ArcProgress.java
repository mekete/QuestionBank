...
/**
 * This view is adapted from
 * https://github.com/lzyzsd/CircleProgress
 */
public class ArcProgress extends View {
    private Paint paint;
    protected Paint textPaint;
   // Typeface condensedFont= FontUtil.createFromAsset(FontUtil.FONT_ROBOTO_CONDENSED_REGULAR);
    ...
    private String centerText =  "0";//Constants. ARC_PROGRESS_STOPPED_CENTER_TEXT;
    ...
    private float default_text_size = 10;//15;
    ...
    public ArcProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        min_size = (int) GraphicsUtil.dp2px(getResources(), 100);
        default_text_size = GraphicsUtil.sp2px(getResources(), 32);
        default_bottom_text_size = GraphicsUtil.sp2px(getResources(), 10);
        default_stroke_width = GraphicsUtil.dp2px(getResources(), 4);
...
//                textPaint.setTypeface(condensedFont);
//            }
