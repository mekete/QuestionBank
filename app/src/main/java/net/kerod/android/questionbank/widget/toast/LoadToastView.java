...
public class LoadToastView extends AppCompatImageView {
    ...
    public LoadToastView(Context context) {
        ...
        successPaint.setColor(ContextCompat.getColor(context,  R.color.colorSuccess));
        errorPaint.setColor(ContextCompat.getColor(context, R.color.colorError));
        ...
        failedIcon = ContextCompat.getDrawable(context, R.drawable.ic_failure);
    ...
    protected void onDraw(Canvas c){
        ...
        float proglength = interpolator.getInterpolation(prog % 3f / 3f)*3f - .75f;
        if(proglength > .75f){
