...
public class LoginActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //
        mStatusTextView = (TextView) findViewById(R.id.txtv_logged_in_user);
        mParentView = findViewById(R.id.content_login);
...
//    }
    ...
    private void initGoogleLogin() {
        ...
        mGoogleLoginButton = new SignInButton(this);
...
//        mFacebookLoginButton.setReadPermissions("email", "public_profile");
    ...
    private void initEmailLogin() {
        mTxtvLoginOrRegister = (TextView) findViewById(R.id.txtv_register_login);
        mTxtvDontHaveAccount = (TextView) findViewById(R.id.txtv_dont_have_account);
        mEmailField = (EditText) findViewById(R.id.txtv_login_email);
        mPasswordField = (EditText) findViewById(R.id.txtv_login_password);
        mPasswordRepeatField = (EditText) findViewById(R.id.txtv_login_repeat_password);
        mBtnnEmailLogin = (Button) findViewById(R.id.btnn_email_login);
        mBtnnForgotPassword=(TextView) findViewById(R.id.btnn_forgot_password);
