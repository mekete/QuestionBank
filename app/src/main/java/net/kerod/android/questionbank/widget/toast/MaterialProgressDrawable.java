...
public class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    public MaterialProgressDrawable(@NonNull Context context, View animExcutor) {
    ...
    private void applyFinishTranslation(float interpolatedTime, @NonNull Ring ring) {
    ...
    private static class Ring {
         ...
         */
        public void draw(@NonNull Canvas c, @NonNull Rect bounds) {
        ...
        private void drawTriangle(@NonNull Canvas c, float startAngle, float sweepAngle, @NonNull Rect bounds) {
            if (mShowArrow) {
                if (mArrow == null) {
                    mArrow = new Path();
